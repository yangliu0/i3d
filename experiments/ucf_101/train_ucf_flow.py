...
FLAGS = flags.FLAGS
model_save_dir = './models/flow_imagenet_20000_6_32_0.0001_decay'
...
def run_training():
    ...
    flow_pre_model_save_dir = "/home/ly/workspace/i3d/checkpoints/flow_imagenet"
    ...
    with tf.Graph().as_default():
        ...
        learning_rate = tf.train.exponential_decay(FLAGS.learning_rate, global_step, decay_steps=5000, decay_rate=0.1,
                                                   staircase=True)
    ...
    train_writer = tf.summary.FileWriter('./visual_logs/train_flow_imagenet_20000_6_32_0.0001_decay', sess.graph)
    test_writer = tf.summary.FileWriter('./visual_logs/test_flow_imagenet_20000_6_32_0.0001_decay', sess.graph)
