...
FLAGS = flags.FLAGS
model_save_dir = './models/rgb_imagenet_10000_6_32_0.0001_decay'
...
def run_training():
    ...
    rgb_pre_model_save_dir = "/home/ly/workspace/i3d/checkpoints/rgb_imagenet/"
    ...
    with tf.Graph().as_default():
        ...
        learning_rate = tf.train.exponential_decay(FLAGS.learning_rate, global_step, decay_steps=3000, decay_rate=0.1,
                                                   staircase=True)
    ...
    train_writer = tf.summary.FileWriter('./visual_logs/train_rgb_imagenet_10000_6_32_0.0001_decay', sess.graph)
    test_writer = tf.summary.FileWriter('./visual_logs/test_rgb_imagenet_10000_6_32_0.0001_decay', sess.graph)
...
def main(_):
    ...
    print('start and end time {} {}'.format(start_date, end_date))
    print("rgb cost time {}".format(end_date - start_date))
