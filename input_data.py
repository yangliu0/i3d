...
def read_clip_and_label(filename, batch_size, start_pos=-1, num_frames_per_clip=32, sample_rate=1, crop_size=224,
    ...
    return np_arr_rgb_data, np_arr_flow_data, np_arr_label.reshape(
        batch_size), next_batch_start, read_dirnames, valid_len
